...
const letter: ILetterItem[] = [
  ...
  },
  {
    ...
    author: 'Илья',
    avatar: kaban,
    text: 'Даже не знаю, с чего начать. Ну, во-первых, с днем рождения!!! Во-вторых... Жаль, что мы все разъехались кто куда, так что пришлось выкручиваться из ситуации и делать вот такой вот подарок, но надеюсь, он тебя улыбнул и порадовал. Хотя текст написать сложнее, чем сайт сделать. Но всё-таки хочется, чтобы в свой день рождения ты только улыбалась и была счастлива. Так что пришлось поскрести по сусекам, поискать фотки и видео, напрячь свои две извилины, чтобы выдать что-нибудь красивое, смешное и милое, и вот что вышло😁 Еще хочу пожелать тебе быть целеустремленной, полной энергии и сил. Посвяти свой день себе😉',
  },
];
